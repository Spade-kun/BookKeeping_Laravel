...
<x-section 
    ...
    <div class="grid md:grid-cols-3 gap-8 stagger-container">
        <div class="stagger-item text-center">
            ...
            <p class="text-gray-600">Get your financial foundation right from day one. Scale with confidence.</p>
        </div>
        ...
        <div class="stagger-item text-center">
            ...
            <h3 class="text-2xl font-bold mb-3">Small Businesses</h3>
            <p class="text-gray-600">Streamline your operations with professional financial management.</p>
        </div>
        ...
        <div class="stagger-item text-center">
            ...
            <h3 class="text-2xl font-bold mb-3">Growing Enterprises</h3>
            <p class="text-gray-600">Advanced financial insights to support your expansion goals.</p>
        </div>
    </div>
</x-section>
...
<x-section 
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 stagger-container">
        ...
        <div class="stagger-item">
            ...
            <p class="text-gray-400">Access to Your Data</p>
        </div>
    ...
    <div class="grid md:grid-cols-3 gap-8 stagger-container">
        <div class="stagger-item">
            <div class="bg-white rounded-lg p-8 text-center shadow-md">
                <div class="bg-blue-100 text-blue-600 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">1</div>
                <h3 class="text-xl font-bold mb-2">Connect</h3>
                <p class="text-gray-600">Link your accounts securely. We integrate with all major platforms.</p>
            </div>
        </div>
        
        <div class="stagger-item">
            <div class="bg-white rounded-lg p-8 text-center shadow-md">
                <div class="bg-blue-100 text-blue-600 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
                <h3 class="text-xl font-bold mb-2">Review</h3>
                <p class="text-gray-600">We organize and categorize your transactions automatically.</p>
            </div>
        </div>
        
        <div class="stagger-item">
            <div class="bg-white rounded-lg p-8 text-center shadow-md">
                <div class="bg-blue-100 text-blue-600 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">3</div>
                <h3 class="text-xl font-bold mb-2">Grow</h3>
                <p class="text-gray-600">Access insights and reports to drive business decisions.</p>
            </div>
        </div>
    </div>
