    ...
    <div class="max-w-4xl mx-auto space-y-20">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center animate-section">
            <div class="order-2 md:order-1">
                <div class="bg-[#E6F2FF] text-[#0066CC] w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">1</div>
                <h3 class="text-3xl font-bold mb-4">Connect Your Accounts</h3>
                <p class="text-lg text-[#4A5568] mb-4">
                ...
                <ul class="space-y-2 text-[#4A5568]">
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#0066CC] mr-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="order-1 md:order-2">
                <div class="bg-gradient-to-br from-[#E6F2FF] to-[#CCE5FF] rounded-2xl p-12 flex items-center justify-center">
                    <svg class="w-32 h-32 text-[#0066CC]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center animate-section">
            ...
            <div>
                <div class="bg-[#E6F2FF] text-[#0066CC] w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">2</div>
                ...
                <ul class="space-y-2 text-[#4A5568]">
                    <li class="flex items-start">
                        ...
                        Professional bookkeeping team assigned to your account
                    </li>
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#0066CC] mr-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center animate-section">
            <div class="order-2 md:order-1">
                <div class="bg-[#E6F2FF] text-[#0066CC] w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">3</div>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center animate-section">
            ...
            <div>
                <div class="bg-[#E6F2FF] text-[#0066CC] w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mb-6">+</div>
                <h3 class="text-3xl font-bold mb-4">Continuous Support</h3>
                <p class="text-lg text-[#4A5568] mb-4">
                    We're always here when you need us. You'll work with our bookkeeping team, and in some plans, a dedicated bookkeeper may be assigned. Support is available via email, phone, or chat to answer questions and provide guidance.
                </p>
                <ul class="space-y-2 text-[#4A5568]">
                    <li class="flex items-start">
                        <svg class="w-5 h-5 text-[#0066CC] mr-2 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-8">
            <div class="flex items-start animate-section">
                ...
                <div>
                    ...
                    <p class="text-[#4A5568]">Initial consultation, account setup, and connection of financial platforms.</p>
                </div>
            </div>
            ...
            <div class="flex items-start animate-section">
                ...
                <div>
                    ...
                    <p class="text-[#4A5568]">We review past transactions and establish your chart of accounts.</p>
                </div>
            </div>
            ...
            <div class="flex items-start animate-section">
                ...
                <div>
                    ...
                    <p class="text-[#4A5568]">Daily transaction recording and categorization begins.</p>
                </div>
            </div>
            ...
            <div class="flex items-start animate-section">
                ...
                <div>
                    ...
                    <p class="text-[#4A5568]">You receive your first complete monthly financial statements.</p>
                </div>
            </div>
        </div>
    </div>
