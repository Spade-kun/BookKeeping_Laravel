...
<x-section 
    ...
    <div class="max-w-3xl mx-auto text-center">
        <p class="text-xl text-[#1a2332] leading-relaxed mb-6">
        ...
        <p class="text-lg text-[#4A5568] leading-relaxed">
...
<x-section 
    ...
    <div class="grid md:grid-cols-3 gap-8 stagger-container">
        <div class="stagger-item text-center">
            ...
            <p class="text-[#4A5568]">We handle your finances with the highest standards of accuracy and ethics.</p>
        </div>
        ...
        <div class="stagger-item text-center">
            ...
            <p class="text-[#4A5568]">Leveraging technology to provide efficient, modern bookkeeping solutions.</p>
        </div>
        ...
        <div class="stagger-item text-center">
            ...
            <p class="text-[#4A5568]">We see ourselves as an extension of your team, invested in your success.</p>
        </div>
    </div>
</x-section>
...
<x-section 
    ...
    <div class="max-w-3xl mx-auto">
        <div class="prose prose-lg max-w-none">
            ...
            <p class="text-[#1a2332] leading-relaxed">
...
<x-section 
    ...
    <div class="grid md:grid-cols-4 gap-8 stagger-container text-center">
        <div class="stagger-item">
            ...
            <p class="text-blue-200">Active Clients</p>
        </div>
        ...
        <div class="stagger-item">
            ...
            <p class="text-blue-200">Managed Annually</p>
        </div>
    </div>
</x-section>
...
<x-section 
    ...
    <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto stagger-container">
        <div class="stagger-item bg-white rounded-lg p-8 text-center shadow-md">
            <div class="w-24 h-24 bg-[#E6F2FF] rounded-full mx-auto mb-4 flex items-center justify-center">
            ...
            <p class="text-[#4A5568]">All team members hold professional certifications and undergo continuous training.</p>
        </div>
        ...
        <div class="stagger-item bg-white rounded-lg p-8 text-center shadow-md">
            ...
            <p class="text-[#4A5568]">Deep expertise across multiple industries including tech, retail, and professional services.</p>
        </div>
        ...
        <div class="stagger-item bg-white rounded-lg p-8 text-center shadow-md">
            ...
            <p class="text-[#4A5568]">Our tech team ensures seamless integration and data security for all clients.</p>
        </div>
    </div>
</x-section>
