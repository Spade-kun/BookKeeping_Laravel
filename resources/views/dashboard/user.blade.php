...
@section('sidebar')
    <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 bg-[#0066CC] text-white rounded-lg transition-colors">
    ...
    <a href="#" class="flex items-center px-4 py-3 text-white hover:bg-blue-900 rounded-lg transition-colors">
        <svg class="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
